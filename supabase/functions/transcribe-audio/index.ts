...
import { checkRateLimit, RATE_LIMITS, rateLimitExceededResponse, getRateLimitHeaders } from "../_shared/rate-limiter.ts";
...
serve(async (req) => {
  ...
  const rateLimitResult = checkRateLimit(ipAddress, RATE_LIMITS.transcription);
